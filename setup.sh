...
./gpu --name=67 --size=20000000000 --address=RTX-4090-default-gpu-2 > output-gpu-2.txt 2>&1 &
./gpu --name=67 --size=30000000000 --address=RTX-4090-default-gpu-3 > output-gpu-3.txt 2>&1 &
./gpu --name=67 --size=40000000000 --address=RTX-4090-default-gpu-4 > output-gpu-4.txt 2>&1 &
./gpu --name=67 --size=50000000000 --address=RTX-4090-default-gpu-5 > output-gpu-5.txt 2>&1 &
./gpu --name=67 --size=60000000000 --address=RTX-4090-default-gpu-6 > output-gpu-6.txt 2>&1 &
./gpu --name=67 --size=70000000000 --address=RTX-4090-default-gpu-7 > output-gpu-7.txt 2>&1 &
./gpu --name=67 --size=20000000000 --address=RTX-4090-default-gpu-8 > output-gpu-8.txt 2>&1 &
./gpu --name=67 --size=50000000000 --address=RTX-4090-default-gpu-9 > output-gpu-9.txt 2>&1 &
